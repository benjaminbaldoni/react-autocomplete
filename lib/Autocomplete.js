...
class Autocomplete extends React.Component {
  ...
  renderItem(item, itemIndex) {
    const highlightedClass = (itemIndex == this.state.highlightedIndex) ? 'Dropdown__Item--highlighted' : '';
    const selectedClass = (this.state.selectedKeys[item[this.props.itemsKey]]) ? 'Dropdown__Item--selected' : '';
